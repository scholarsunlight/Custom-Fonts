...
## Font Lookbooks and Inspiration

>Websites and resources that help with choices related to colors

| Website&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; | Description |
| ----------------------- | ------------------ |
| [Fontshare](https://fontshare.com/) | Free fonts service from the Indian Type Foundry (ITF), making quality fonts and typography inspiration accessible to all 
| [Typespiration](https://typespiration.com/) | Free font combinations and color palettes to inspire your designs
| [FontBolt](https://colorbrewer2.org/) | Discover and generate your favorite fonts from pop culture |
| [FontPair](https://fontpair.co) | Comprehensive collection of fonts from Google Fonts and FontShare along with thousands of curated font pairings and live examples of fonts in use on real websites |
| [Use & Modify](https://usemodify.com/) | Personal selection of beautiful, classy, punk, professional, incomplete, weird typefaces |
| [Font Fabric](https://colorcurves.app)| Color palette generator that uses curves to generate color palettes |
...
| [Avopix](https://https://avopix.com/) | a searchable collection of free stock photos, vectors, and videos all in one place.
